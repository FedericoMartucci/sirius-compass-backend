...
from app.tools.db_reader import get_latest_audit_report, get_developer_activity 

def build_chat_graph():
    """
    Interactive Chatbot with Granular DB Access.
    """
    # 1. Setup Tools (Agregamos get_developer_activity)
    tools = [get_latest_audit_report, get_developer_activity]
    ...
    # ... (El resto del código del grafo es igual al anterior) ...
